...
function App() {
  ...
  function csv2table(csv) {
    ...
    rows.forEach(function (row, idx) {
      ...
      html += '<tr>';
      columns.forEach(function (column) { html += '<td>' + column + '</td>'; });
      html += '</tr>';
    });
    html += '</table>';
    return html;
...
*/
  ...
  return (
    // <div className="App" style={{ width: '100vw', height: '100vh', overflowX: 'auto', backgroundColor: "white" }}>
    <div className="App" style={{ width: '100vw', height: '100vh', backgroundColor: "white" }}>
      {/*<选择文件的input*/}
      ...
      <div id="result"
        ...
        style={{ width: "100vw", height: "100vh", fontSize: "40px" }}>
      </div>
    </div>
  );
}
